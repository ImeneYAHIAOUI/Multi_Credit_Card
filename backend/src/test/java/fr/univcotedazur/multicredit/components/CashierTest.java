...
class CashierTest {
    ...
    void processToPayment1() {
        Assertions.assertThrows(PaymentException.class, () -> cashier.payment(purchaseOfJohn, "1234567999123456"));
    }

    @Test
    void processToPayment2() {

        Assertions.assertThrows(PaymentException.class, () -> cashier.payment(purchaseOfJohn, null));
    }

    @Test
    void identifyPaymentError() {
        Assertions.assertThrows(PaymentException.class, () -> cashier.payment(purchaseOfPat, "1234567999123456"));
    }
}