...
Shop shop;
    ...
    public void aMemberWhoWantsToCreateAnAccount() throws MissingInformationException{
        ...
        Product product=new Product(UUID.randomUUID(),"ring",1.0,0);
        Product product1=new Product(UUID.randomUUID(),"Cookie",2.0,0);
        Product product2=new Product(UUID.randomUUID(),"Cake",1.0,0);
        Product product3=new Product(UUID.randomUUID(),"ring",1.0,0);
        Product product4=new Product(UUID.randomUUID(),"chocolat",1.5,0);
