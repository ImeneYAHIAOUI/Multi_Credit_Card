...
public class ParkingController {
    ...
    public ResponseEntity<ParkingDTO> startParkingTime(@RequestBody @Valid ParkingDTO parkingDTO) {
        ...
        try {
            ...
            LocalDateTime start = LocalDateTime.ofInstant(Instant.ofEpochSecond(iswuplsdto.getParkingDateTime()), TimeZone.getTimeZone("Europe/Paris").toZoneId());
            LocalDateTime end = LocalDateTime.ofInstant(Instant.ofEpochSecond(iswuplsdto.getParkingEndDateTime()), TimeZone.getTimeZone("Europe/Paris").toZoneId());
