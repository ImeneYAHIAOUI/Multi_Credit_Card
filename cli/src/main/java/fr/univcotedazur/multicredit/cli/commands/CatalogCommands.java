...
public class CatalogCommands {
    ...
    public String deleteGift(@ShellOption(value = {"-i", "--id"}) Long id) {
        ...
        try {
            restTemplate.exchange(BASE_URI + "/Gifts/" + id, HttpMethod.DELETE, null, String.class);
    ...
    public String deleteProduct(@ShellOption(value = {"-i", "--id"}) Long id) {
        ...
        try {
            restTemplate.exchange(BASE_URI + "/Products/" + id, HttpMethod.DELETE, null, String.class);
    ...
    public String getGift(Long id) {
        try {
            ...
            if (p == null) throw new HttpClientErrorException(HttpStatus.NOT_FOUND);
