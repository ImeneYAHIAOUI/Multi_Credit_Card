...
public class ShopCommands {
    ...
    public String updateShopAddress(Long id, String address) {
        ...
        try {
            ...
            restTemplate.exchange(BASE_URI + "/" + id + "/address", HttpMethod.PUT, request, String.class);
    ...
    public String getShopKeeper(Long id) {
        try {
            return restTemplate.getForObject(BASE_URI + "/shopKeepers/" + id.toString(), String.class);
        } catch (HttpClientErrorException ex) {
            if (HttpStatus.NOT_FOUND.equals(ex.getStatusCode())) {
